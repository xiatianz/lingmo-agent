...
export const translations = {
  zh: {
    ...
    generatingOutlineTitle: '正在生成文章大纲',
    generatingOutlineDesc: '灵墨正在分析主题、关键词和文章结构，稍等片刻就能确认大纲。',
    writingStatus: '正在生成正文...',
    writingStatusDesc: '已收到大纲，正在按结构创作正文。',
    ...
    modeLite: '快速生成',
    modeDeepAgent: '深度创作',
    modeLiteDesc: '更快生成正文，适合日常文章和草稿。',
    modeDeepAgentDesc: '先检索再组织内容，适合更完整、更深入的长文。',
  ...
  en: {
    ...
    generatingOutlineTitle: 'Generating article outline',
    generatingOutlineDesc: 'Lingmo is analyzing the topic, keywords, and structure before drafting.',
    writingStatus: 'Writing article...',
    writingStatusDesc: 'Outline confirmed. Lingmo is drafting the article.',
    ...
    modeLite: 'Quick Draft',
    modeDeepAgent: 'Deep Writing',
    modeLiteDesc: 'Faster drafting for everyday articles and first drafts.',
    modeDeepAgentDesc: 'Researches first and writes with more depth for longer pieces.',
